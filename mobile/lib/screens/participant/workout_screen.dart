...
class _WorkoutScreenState extends State<WorkoutScreen> {
  ...
  // Track completed sets per exercise index
  Map<int, int> _completedSets = {};
              ...
              : RefreshIndicator(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('${_plan!.exercises.length} exercises',
                              style: const TextStyle(color: Colors.white70)),
                            const SizedBox(height: 12),
                            // Progress bar
                            LinearProgressIndicator(
                              value: _plan!.exercises.isEmpty ? 0
                                  : _completedSets.length / _plan!.exercises.length,
                              backgroundColor: Colors.white24,
                              valueColor: const AlwaysStoppedAnimation(Colors.white),
                            ),
                            const SizedBox(height: 4),
                            Text(
                              '${_completedSets.length} / ${_plan!.exercises.length} completed',
                      ...
                      ...List.generate(_plan!.exercises.length, (i) {
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: _muscleColor(ex.muscleGroup).withOpacity(0.12),
                      ...
                      const SizedBox(height: 16),
                      if (_completedSets.length == _plan!.exercises.length &&
                          _plan!.exercises.isNotEmpty)
                        Container(
                          padding: const EdgeInsets.all(16),
                          decoration: BoxDecoration(
